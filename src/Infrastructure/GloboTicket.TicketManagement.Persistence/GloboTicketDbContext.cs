...
namespace GloboTicket.TicketManagement.Persistence
{
    public class GloboTicketDbContext : DbContext
    {
        ...
        {
            //ApplyConfigurationsFromAssembly will check for all configurations in the assemply.
            //And it will pick the configurations provided in the Configurations folder.
